    ...
    return(
        <div>
            <form action={formAction}>
                <input type="text" name="title" placeholder="Title" value={titleValue} onChange={(e)=>setTitleValue(e.target.value)} maxLength={LENGTHS.challengeTitle}/>
                <input type="text" name="description" placeholder="Description" value={descriptionValue} onChange={(e)=>setDescriptionValue(e.target.value)} maxLength={LENGTHS.challengeDescription}/>
                <br></br>
